...
if __name__ == '__main__':
    ...
    compute_pr_curve(config, foreground_classes, img_filenames,
                     imdb.annotations_file_data['objects'],
                     all_results,
                     save_dir_pr_curve,
                     args.dpi)
    ...
    save_dir_viz = save_dir_viz = os.path.join(output_dir, 'detections_visualizations')
    compute_tokenwise_eval(
        data_path,
        testset_fn_only,
        foreground_classes,
        all_results,
    ...
    # post-processing and token-wise eval again
    # print('-- token-wise evaluation with the post processing --')
    # compute_tokenwise_eval(data_path, testset_fn_only, all_results, save_dir_viz, predicted_token_dir, args.dpi,
    # token_post_process=True)
