...
def parse_args():
  ...
  parser.add_argument('--checkpoint_epochs_interval', dest='checkpoint_epochs_interval',
                      help='number of epochs to save a checpoint',
                      default=1, type=int)
...
if __name__ == '__main__':
  ...
  if args.dataset == "pascal_voc":
      ...
      #                 'MAX_NUM_GT_BOXES', '20']
      args.set_cfgs = ['ANCHOR_SCALES', '[2, 13, 16, 19, 32]', 'ANCHOR_RATIOS', '[0.0977, 0.132, 0.2, 0.2219, 0.6562]',
                       'MAX_NUM_GT_BOXES', '40']
